...
<div class="form-container">
    <form method="POST" action="editmakanan.php">
        ...
        <label>Harga:</label>
        <input type="text" name="harga_makanan" value="<?php echo $data['harga_makanan']; ?>" required>
        <button type="submit" name="update">Update</button>
    </form>
    <div class="back-button">
        <a href="datamakanan.php">Back to food table</a>
    </div>
</div>
